...
#  define MODARCH "_i386"
	...
	{"dmc",               "dmc.so",                   "dmc.dll",           "Deathmatch Classic (Steam)"},
	{"dod",               "dod" MODARCH ".so",          "dod.dll",           "Day of Defeat"},
	{"dod",               "dod.so",                   "dod.dll",           "Day of Defeat (Steam)"},
	...
	{"gearbox",           "opfor.so",                 "opfor.dll",         "Opposing Force (Steam)"},
	...
	{"ns",                "ns.so",                    "ns.dll",            "Natural Selection (Steam)"},
	...
	{"ricochet",          "ricochet.so",              "mp.dll",            "Ricochet (Steam)"},
	...
	{"stargatetc",        "hl.so",                    "hl.dll",            "StargateTC (Legacy v1.x)"},
	{"stargatetc",        "stc_i386.so",              "hl.dll",            "StargateTC (v2.x)"},
	{"stargatetc",        "stc_i386_opt.so",          "hl.dll",            "StargateTC (v2.x, optimised)"},
	...
	{"tfc",               "tfc.so",                   "tfc.dll",           "Team Fortress Classic (Steam)"},
	...
	{"valve",             "hl.so",                    "hl.dll",            "Half-Life Deathmatch (Steam)"},
	...
	{"wizwars",           "mp" MODARCH ".so",           "hl.dll",            "Wizard Wars (Legacy)"},
